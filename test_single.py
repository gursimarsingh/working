...
if __name__ == '__main__':
    ...
    for i in range(0,len(files),2):
        print (files[i])
        points1,t1 = get_points_from_img(os.path.join(folder,files[i]),simpleto=sampls)
        points2,t2 = get_points_from_img(os.path.join(folder,files[i+1]),simpleto=sampls)
